...
public class Diagnostico extends javax.swing.JFrame {
    ...
    public Diagnostico(SQLclass query) {
        initComponents();
        
        this.query=query;
        behaviors.setModel(query.query("select * from diagnostico", v));
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Insertar Diagnostico");

        jButton2.setText("Add Diagnostico");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        if (JOptionPane.showConfirmDialog(null, "¿Confirma insertar Diagnostico " + hijoNom.getText() + " con id=" + hijoId.getText() + " y padre con id=" + hijoDe.getText()) == 0) {
            ...
            String comand = "insert into diagnostico (id,nombre,detalle) values (" + id + ", " + nom + "," + detalle + ")";
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if (JOptionPane.showConfirmDialog(null, "¿Confirma actualizar el diagnostico " + nomTable + " con id=" + idTable + " y descripción" + detalleTable) == 0) {
            ...
            String p = "update diagnostico set detalle=" + detalleNew.getText() + ", nombre=" + nomNew.getText() + "where id=" + idTable;
            ...
            query.ejecutar("update diagnostico set id=" + id + ", nombre=" + nom + ", detalle=" + detalle + " where id=" + idTable);
...
String idTable,nomTable,detalleTable;
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Diagnostico(query).setVisible(true);
            }
        });
    }
